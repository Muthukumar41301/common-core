...
import com.core.lib.service.KafkaConsumerService;
...
public class TaxServiceImpl implements TaxService {
    ...
    public TaxRecord calculateTax(String userName, double income) {
        ...
        // Delegate tax calculation to KafkaConsumerService (shared logic)
        ...
        log.info("Saved TaxRecord: {}", savedRecord);
        return savedRecord;
    }

    // Get a single record from Redis cache
    @Override
